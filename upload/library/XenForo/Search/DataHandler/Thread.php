...
class XenForo_Search_DataHandler_Thread extends XenForo_Search_DataHandler_Abstract
{
	...
	{
		return array(
			'name' => new XenForo_Phrase('thread'),
			'route' => 'inline-mod/thread/switch',
			'cookie' => 'threads',
			'template' => 'inline_mod_controls_thread'
		);
	}
	...
	{
		return $this->_getThreadModel()->addInlineModOptionToThread($result, $result, $result['permissions']);
	}
